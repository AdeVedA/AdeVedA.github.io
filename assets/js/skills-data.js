    ...
    skills: [
      {
        ...
        name: "Python / POO",
        icon: "pypackage",
        description: "Conception et développement orienté objet en Python",
        githubLinks: [
          {
          ...
          {
            title:
              "API RESTful sécurisée pour la gestion collaborative de projets et le suivi des problèmes techniques",
      ...
      {
        id: "workers",
        name: "Workers & Thread Management",
        icon: "thread",
        description:
        ...
        githubLinks: [
          {
            title:
              "Thread manager : enregistrer/démarrer/stopper/unregister les threads Qt et Python",
      ...
      },
      {
        ...
        icon: "flask",
        customIcon: true,
        description: "Applications web légères avec le micro-framework Flask",
        githubLinks: [
          {
            title:
              "Plateforme de réservation pour des compétitions - Web App Flask",
      ...
      },
      {
        ...
        icon: "terminal",
        description: "Applications en ligne de commande suivant le pattern MVC",
        githubLinks: [
          {
            title: "Gestionnaire de relation client Epic Events en MVC - CLI",
            url: "https://github.com/AdeVedA/EpicEventsCRM--OCR_Mission11",
    ...
    skills: [
      {
        ...
        githubLinks: [
          ...
          {
            title:
              "Context panel - Gestion de contexte OFF/Full/RAG (gui/context_parser_panel.py)",
          ...
          {
            title:
              "Widgets pour spinners, boite de dialogue de configuration et de validation... (gui/widgets/…)",
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "Consultation de catalogue de films, Web App responsive html/css/js à partir de patron Figma",
          ...
          {
            title:
              "Plateforme de locations, Web App Django avec CI/CD, Docker, deployé sur Render, documenté sur ReadTheDocs",
    ...
    skills: [
      {
        ...
        icon: "sqlite",
        customIcon: true,
        description: "Bases de données embarquées avec SQLite et ORM Django",
        githubLinks: [
          {
            title:
              "Plateforme de locations, Web App Django avec CI/CD, Docker, deployé sur Render, documenté sur ReadTheDocs",
      ...
      },
      {
        ...
        icon: "DBmigration",
        customIcon: true,
        description: "Gestion des migrations et modélisation des données",
        githubLinks: [
          {
            title:
              "Plateforme de locations, Web App Django avec CI/CD, Docker, deployé sur Render, documenté sur ReadTheDocs",
    ...
    skills: [
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "Initialisation du serveur Ollama et instanciation de LLM avec langChain_ollama.OllamaLLM dans core/llm_manager.py",
            url: "https://github.com/AdeVedA/AInterfAI/blob/main/core/llm_manager.py",
          },
        ],
      },
      {
        ...
        githubLinks: [
          ...
          {
            title:
              "Assemblage avec Langchain de prompt system et de l'historique de session pour requête normale ou RAG",
            url: "https://github.com/AdeVedA/AInterfAI/blob/main/core/prompt_manager.py",
          },
        ],
      },
    ...
    skills: [
      {
        ...
        name: "Workflow CI/CD",
        icon: "githubactions",
        description: "Intégration et déploiement continu avec GitHub Actions",
        githubLinks: [
          {
            title:
              "Plateforme de locations, Web App Django avec CI/CD, Docker, deployé sur Render, documenté sur ReadTheDocs",
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "Utilisation de git a minima pour tous mes projets visibles sur github",
    ...
    skills: [
      {
        ...
        githubLinks: [
          {
            title:
              "Conception de l'interface-utilisateur, des fonctionnalités et participation à la modélisation des données avec le développeur",
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "Résultat opérationnel de l'algorithme de nommage sur le site Harmotone",
            url: "https://harmotone.net",
          },
        ],
      },
      {
        ...
        githubLinks: [
          {
            title:
              "Algorithme bruteforce récursif pour la décision d'investissements financiers",
            url: "https://github.com/AdeVedA/AlgoInvestor--OCR_Mission6/blob/main/bruteforce.py",
          },
          {
            title:
              "Algorithme glouton optimisé pour la décision d'investissements financiers",
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "structuration de données en Python pour un scraping ETL de librairie en ligne",
            url: "https://github.com/AdeVedA/BScraper--Ocr_Mission1",
          },
          {
            title:
              "Analyse et visualisation de données avec matplotlib pour les schémas du readme",
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "JSON Web Token - API RESTful sécurisée pour la gestion collaborative de projets et le suivi des problèmes techniques",
            url: "https://github.com/AdeVedA/SoftDeskAPI--OCR_Mission9/",
          },
          {
            title:
              "bcrypt - Gestionnaire de relation client Epic Events en MVC - CLI",
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "Bruno & Postman - API RESTful sécurisée pour la gestion collaborative de projets et le suivi des problèmes techniques",
            url: "https://github.com/AdeVedA/SoftDeskAPI--OCR_Mission9",
          },
        ],
      },
      ...
      },
      {
        ...
        githubLinks: [
          {
            title:
              "La plupart des projets sur mon repository bénéficie du linting Flake8 et du formattage Black",
            url: "https://github.com/AdeVedA?tab=repositories",
          },
        ],
      },
